...
let personSalutation =  document.querySelector('.salutation')
let personImage = document.querySelector('#image')
...
function setPerson(){
  content.textContent = `${persons[index].text}`
  personName.textContent = `${persons[index].name}`
  personSalutation.textContent = `${persons[index].position}`
  personImage.src = `${persons[index].photo}`
}